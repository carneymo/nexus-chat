...
Blackjack audio reuses Nexus's triangle-wave synth and Sound setting: wagers, cards, your turn, and personal win/loss/push outcomes. Initial and repeated snapshots stay silent; hidden tabs suppress playback. Transition classification tests pass. Browser audio still requires a user gesture; final volume/tone preference should be reviewed by listening locally.
